      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: [
              if (_isDoctor) Tab(text: 'Requests'),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text(message, style: TextStyle(fontSize: 18, color: Colors.grey[400])),
        ],
      ),
    );
  }
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return Dialog(
              ...
              backgroundColor: Colors.grey[900],  // Dark grey dialog
              child: Padding(
  ...
  void _confirmDelete(String userId, Timestamp date) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Are you sure you want to delete this booking?', style: TextStyle(color: Colors.grey[400])),
        actions: [
          TextButton(
  ...
  void _showModernSnackBar(BuildContext context, String message, {bool isError = false}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? Colors.redAccent : Colors.grey[800],  // Darker grey for success
