                      ...
                      child: cachedRating != null
                          ...
                          : FutureBuilder<double>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                state?._cacheData(state._cachedHospitals,
                                    state._cachedRatings);
    ...
    return Row(
      ...
      children: [
        Icon(
          Icons.star_rounded,
          color:
              loading ? Colors.white.withOpacity(0.5) : const Color(0xFFFFD700),
          size: 16,
        ),
